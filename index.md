...
## 1 April, 2015
**Presentation Slides**--[Powerpoint](DhPpt.ppt)
...
In 1824 Mary Russell Mitford published a series of sketches of rural England collected under the title Our Village. The sketches were compared with Jane Austen’s novels in their meticulous attention to village social life. Mitford depicts the English village as a place where unique forms of affect can be cultivated within the social networks that form there. In Mitford’s rural British village she dwells within a social network that includes animals and even plants. The paper will explore to what degree nonhumans forge the links between the characters of Mitford’s sketches. In addition to close reading of several passages, visualizing the social networks of Mitford’s Three Mile Cross (perhaps using a force-directed graph) will help to place the work’s animals more clearly within those networks, answering the question of how often and to what extent relationships between humans from because of Mitford’s animal character, and whether animal characters influence relationships between humans of different social classes. Other questions such visualizations might answer include whether significant relationships form between humans and animals or between animals themselves. Can mapping Mitford’s many walks—destinations, noted pauses, encounters— reveal patterns that speak to the significance of village flora in relation to Mitford’s friendships? Finally, Topic modeling of the text of Our Village shows that animals, plants, characters, appear together throughout the work along with words related to nationality. How does Mitford connect her village, already a setting rife with nostalgic resonance when it was published in the 1820s, to a national identity?  

**Bonus: fun fact!**-- Currently, in Three Mile Cross, Mitford's Village, there is a dog swim therapy clinic off the main road. It is called '[Aquadoggies K9 Hydrotherapy Pool!](http://www.aquadoggies.com)'.

**Scope**- Mitford’s nonhuman inhabitants may occupy most of the essay, and the question of national identity, although significant, may exceed the scope of the project.

**Concerns** -- tool use. Too many tools? Will the visual elements add enough to the argument to make them worth using or are they simply confirming what I found with good old fashioned reading?

**Potential Journal**- Women’s Writing (WoWr)


## 24 February, 2015
After some internal conflict, the limitations of aging hardware and personal inexperience convinced me to scrap my intended project (academically; casually, it's a question I intend to keep in mind). At this point, I'm thinking I'll return to at an essay I wrote during my M.A. on 19th century author Mary R. Mitford's *Our Village.* I wrote about how Mitford presents the rural English village as a chronotope in which unique social networks can form between persons of different classes and species, in which even the flowers have cultural and social significance. Initial efforts towards topic modeling have confirmed that animals, plants, characters, affect and nationality all appear in significantly related clusters (along with colors and relationship words-- e.g., "father" or "friend"). Force-directed visualizations of relationships would help see just how integrated animals are into Mitford's social network. The original intention for the project was a visual exploration of social networks. At the time I didn't have the tools, but [Protovis](http://mbostock.github.io/protovis/ex/force.html"Force-directed Layouts) has some code and examples of various visualizations, and RStudio, Voyant, and Mallet may also be helpful. Perhaps community recognition algorithms might be worth considering? Protovis's force-directed layouts (linked to above) would be ideal for seeing just how much weight and which connections each character really has. 
Additionally, mapping might be worth considering. How could visualized networks, topic modeling, and the locations of Mitford's Three Mile Cross be integrated? Is the use of visualization going to nuance my argument or simply reinforce my established findings? 

## 18 February, 2015 Annotated Bibliography
...
##4 February, 2015, Edited Thought Pieces
...
## 27 January, 2015, Thought Piece and Reviews
...
## 20 January, 2015: Response to Galloway's *Love of the Middle*
